...
![Word macros](https://github.com/sh3llxy/sh3llxy.github.io/blob/main/_posts/img/1.png){: width="990" height="607" .w-50}


**The autoOpen macro executes a PowerShell command as follows :**
 ![autoOpen execute](https://github.com/sh3llxy/sh3llxy.github.io/blob/main/_posts/img/2.png)<br>
