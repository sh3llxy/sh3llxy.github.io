...
**The autoOpen macro executes a PowerShell command as follows :**
 ![autoOpen execute](https://github.com/sh3llxy/sh3llxy.github.io/blob/main/assets/images/Insights-from-the-Initial-Compromise-Phase/img/2.png)
 <br>
